<template>
  <footer class="max-w-2xl mx-auto px-5 md:px-10 py-8 text-theme-text-tertiary flex flex-col lg:flex-row flex-wrap justify-between items-center">
    <div class="mb-4 lg:mb-0 text-center md:text-left">
      <span class="block md:inline-block mb-4 md:mb-0 text-center">&copy; <a href="https://KAPU.one" target="_blank">KAPU.one</a> | {{ year }}. {{ $t("All rights reserved") }}</span> <div class="block md:inline-block"><span class="hidden md:inline-block"> | </span> <span>{{ $t("Version") }}: <a :href="versionLink" target="_blank">{{ version }}</a> | {{ $t("Date") }}: {{ date }}</span></div>
    </div>
    <div class="text-center">
      <a href="https://www.facebook.com/kapucoin" target="_blank">
        <svg
          viewBox="0 0 24 24"
      ...
      <a href="https://twitter.com/kapucoin" target="_blank">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://forum.kapu.one" target="_blank">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://blog.kapu.one" target="_blank">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="http://t.me/joinchat/AAAAAEO9aD3Zve2u0uxbsg" target="_blank">
        <svg
          viewBox="0 0 14 14"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://www.reddit.com/r/kapucoin" target="_blank">
        <svg
          viewBox="0 0 17 17"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://www.github.com/kapucoin" target="_blank">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://bitcointalk.org/index.php?topic=2035561.0" target="_blank">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://slack.kapu.one/" target="_blank">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://discord.gg/ZyP9uF" target="_blank">
        <svg
          viewBox="0 0 24 24"
          class="m-2"
          xmlns:xlink="http://www.w3.org/1999/xlink"
...
export default {
  computed: {
    ...
    versionLink() {
      return `https://github.com/gsilvestri/kapu-explorer/commit/${GIT_VERSION}`
    },
    date() {
      return GIT_DATE
    }
